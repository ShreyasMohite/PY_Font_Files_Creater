...
class File:
    def __init__(self,root):
        self.root=root
        self.root.title("Font File Extention")
        self.root.geometry("500x400")
        self.root.iconbitmap("logo101.ico")
...
#======================================================================================#
        ...
        def clear():
            ...
            filextention.set("Font File Extention")
        ...
        def genrate():
            try:
                if path.get()!="":
                    ...
                    if filextention.get()!="Font File Extention":
                        if filename.get()!="":

                            if filextention.get()=="Windows font file" and filename.get()!="":
                                touch.touch(a+"/{}.fnt".format(filename.get()))
                            
                            if filextention.get()=="Generic font file" and filename.get()!="":
                                touch.touch(a+"/{}.fon".format(filename.get()))
                        

                            if filextention.get()=="Open type font file" and filename.get()!="":
                                touch.touch(a+"/{}.otf".format(filename.get()))
                            

                            if filextention.get()=="TrueType font file" and filename.get()!="":
                                touch.touch(a+"/{}.ttf".format(filename.get()))
...
#======================================================================================#
        ...
        fileselect=["Windows font file","Generic font file","Open type font file","TrueType font file"]
        fileselect_combo=Combobox(firstframe,values=fileselect,font=('arial',12),width=25,state="readonly",textvariable=filextention)
        fileselect_combo.set("Font File Extention")
